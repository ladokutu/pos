...
export default function DataTable() {
  ...
  const deleteselected = async (selectedid) => {
			...
			try {
				...
				var api='https://panen.ladokutu.info/index.php/Solution/delete_data_master_department';  
				const response = await axios({
					method: 'post',
					headers: headers_data,
					url: api,
	...
	const view_edit_data = async (id) => {
			...
			try {
				...
				var api='https://panen.ladokutu.info/index.php/Solution/view_data_master_department';  
				const response = await axios({
					method: 'post',
					headers: headers_data,
					url: api,
	...
	const EditData = async (event) => {
		...
		try { 
            ...
            var api='https://panen.ladokutu.info/index.php/Solution/edit_data_master_department';  
			const data_body = { 
					'id': value,
                    'id_depart': id_depart,
					'department': department,
